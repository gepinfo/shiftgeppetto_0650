...
export class treeentityController implements Controller {
    ...
    private initializeRoutes() {
        this.router.delete('/treeentity/:id', this.GpDelete);
this.router.get('/treeentity/get/search', this.GpSearch);
this.router.put('/treeentity/get/update', this.GpSearchForUpdate);
this.router.put('/treeentity', this.GpUpdate);
this.router.get('/treeentity/:id', this.GpGetEntityById);
this.router.get('/treeentity', this.GpGetAllValues);
this.router.post('/treeentity', this.GpCreate);
this.router.get('/treeentity/userid/created_by', this.GpGetNounCreatedBy);
this.router.get('/treeentity/get/tree', this.GpGetAllTree);
        //#@gepdelimeterone@#
        //#@ssofacebookapiroute@#
        //#@ssogithubapiroute@#
        //#@gepbankingapiroute@#
...
public GpDelete(req: Request, res: Response) {
        ...
        new ApiAdapter().delete(Constant.SHIFTTREECRUDURL + `${req.url}` )
...
public GpSearch(req: Request, res: Response) {
        ...
        new ApiAdapter().get(Constant.SHIFTTREECRUDURL + `${req.url}` )
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpSearchForUpdate(req: Request, res: Response) {
        ...
        new ApiAdapter().put(Constant.SHIFTTREECRUDURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpCreate(req: Request, res: Response) {
        ...
        new ApiAdapter().post(Constant.SHIFTTREECRUDURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
